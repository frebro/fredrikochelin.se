/*
 ...
 MyFonts Webfont Build ID 2974691, 2015-02-18T05:20:47-0500
 ...
 Webfont: Montana-Regular by Resistenza
 URL: http://www.myfonts.com/fonts/resistenza/montana/regular/
 Copyright: Rsz
 Licensed pageviews: 20,000


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2974691

 ? 2015 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2d63e3";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=1,woff2Enabled=0;
...
/(Macintosh|Android)/.test(navigator.userAgent)&&"svg#wf"!=webfontType&&(suffix="_unhinted");var head=document.getElementsByTagName("head")[0],stylesheet=document.createElement("style");stylesheet.setAttribute("type","text/css");head.appendChild(stylesheet);var fonts=[{fontFamily:"Montana-Regular",url:wfpath+"2D63E3_0"+suffix+"_0."+webfontType}],len=fonts.length,data_fn;
"ttf"==webfontType?data_fn="_unhinted"==suffix?"2D63E3_data_unhintedttf.css":"2D63E3_datattf.css":"woff"==webfontType&&(data_fn="_unhinted"==suffix?"2D63E3_data_unhintedwoff.css":"2D63E3_datawoff.css");var link=document.createElement("link");link.setAttribute("rel","stylesheet");link.setAttribute("type","text/css");link.setAttribute("href",wfpath+data_fn);head.appendChild(link);
